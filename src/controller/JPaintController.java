...
public class JPaintController implements IJPaintController {
    ...
    private void setupEvents() {
        ...
        uiModule.addEvent(EventName.COPY, () -> new CopyCommand(mouse.getClipboard()).run());
        uiModule.addEvent(EventName.PASTE, () -> new PasteCommand(mouse.getClipboard(),mouse.getCanvas(),mouse.getShapeList()).run());
        uiModule.addEvent(EventName.DELETE, () -> new DeleteCommand(mouse.getCanvas(),mouse.getShapeList()).run());
